        ...
        <div class="inner">
            ...
            <form action="">
                ...
                <div class="form-wrapper">
                    <input type="text" placeholder="Email" class="form-control" name="email" style="box-shadow: none; border-color: #1a1e21;">
                    <i class="zmdi zmdi-email"></i>
                </div>
                <div class="form-wrapper">
                    <input type="password" placeholder="Password" class="form-control" name="password" style="box-shadow: none; border-color: #1a1e21">
                ...
                <br/>
                <div><p>No account? <a href="/signup" class="signup">Sign up</a></p></div>
            </form>
        </div>
    </div>
</div>
